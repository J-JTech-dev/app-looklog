...
class ItemList extends StatefulWidget {
  ...
  final String imgUrl;
  final bool check;
  const ItemList({super.key,required this.index, required this.title, required this.brand, required this.size, required this.date, required this.imgUrl, required this.check});
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Container(
                              ...
                              margin: EdgeInsets.only(top: AppConfig.h(10), bottom: AppConfig.h(51)),
